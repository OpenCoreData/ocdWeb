...
WHERE
{
 ...
 OPTIONAL { <http://opencoredata.org/id/resource/csdco/feature/{{.HOLEID}}> csdco:elevation ?elevation } .
 OPTIONAL { <http://opencoredata.org/id/resource/csdco/feature/{{.HOLEID}}> csdco:hole	 ?hole } .
 OPTIONAL { <http://opencoredata.org/id/resource/csdco/feature/{{.HOLEID}}> csdco:holeid ?holeid } .
 OPTIONAL { <http://opencoredata.org/id/resource/csdco/feature/{{.HOLEID}}> csdco:locationid	 ?locationid } .
 OPTIONAL { <http://opencoredata.org/id/resource/csdco/feature/{{.HOLEID}}> csdco:locationname	 ?locationname } .
 OPTIONAL { <http://opencoredata.org/id/resource/csdco/feature/{{.HOLEID}}> csdco:locationtype ?locationtype } .
 OPTIONAL { <http://opencoredata.org/id/resource/csdco/feature/{{.HOLEID}}> csdco:mblfb	 ?mblfb } .
 OPTIONAL { <http://opencoredata.org/id/resource/csdco/feature/{{.HOLEID}}> csdco:mblft ?mblft } .
 OPTIONAL { <http://opencoredata.org/id/resource/csdco/feature/{{.HOLEID}}> csdco:pi	 ?pi } .
 OPTIONAL { <http://opencoredata.org/id/resource/csdco/feature/{{.HOLEID}}> csdco:platform	 ?platform } .
 OPTIONAL { <http://opencoredata.org/id/resource/csdco/feature/{{.HOLEID}}> csdco:position ?position } .
 OPTIONAL { <http://opencoredata.org/id/resource/csdco/feature/{{.HOLEID}}> csdco:project	 ?project } .
 OPTIONAL { <http://opencoredata.org/id/resource/csdco/feature/{{.HOLEID}}> csdco:sampletype	 ?sampletype } .
 OPTIONAL { <http://opencoredata.org/id/resource/csdco/feature/{{.HOLEID}}> csdco:site ?site } .
 OPTIONAL { <http://opencoredata.org/id/resource/csdco/feature/{{.HOLEID}}> csdco:sitehole ?sitehole } .
 OPTIONAL { <http://opencoredata.org/id/resource/csdco/feature/{{.HOLEID}}> csdco:state_province	 ?state_province } .
...
func BasementTS() (*sparql.Repo, error) {
	...
	repo, err := sparql.NewRepo("http://triplestore.opencoredata.org/blazegraph/namespace/kb/sparql",
